...
// /**
//  * 1. Стаоріть масив styles з елементом "jazz" і "blues"
//  * Додайье в кінець "rock-n-roll"
//  * Замініть значення "blues" на "classic"
//  * Напишіть функцію logItems(array), яка приймає масив і використовує
//  * цикл for, який для кожного елемента буде виводити повідомлення у форматі:
//  * <номер елемента> - <значення елемента>. Нумерація має починатися з 1.
//  */
...
// /**
//  * 2. Напиши функцію checkLogin(array), яка перебирає масив логінів
//  * і перевіряє чи є ім'я введене в prompt у цьому масиві і у разі,
...
//   const login = prompt("Enter yor login");
...
// /**
//  *  3. Напишіть функцію, яка складатиме сусідні числа і пушитиме їх в новий
//  * масив const someArr = [22,11,34,5,12,13,14,15]
//  */
// const someArr = [22, 11, 34, 5, 12, 13, 14, 15];
// function sum(array) {
//   const newArray = [];
//   for (let i = 0; i < array.length - 1; i++) {
//     const curentEl = array[i];
//     const nextEl = array[i + 1];
//     newArray.push(curentEl + nextEl);
//   }
//   return newArray;
// }
...
// /**
//  * 4. Напиши скрипт, який для об'єкту user, послідовно:
...
// /**
//  * 5. Створіть об'єкт calculator з наступними методами:
//  * read(a, b) - приймає два аргумента і зберігає їх як властивість об'єкта sum()
//  * повертає суму збережених значень (з перевіркою на наявність властивостей в об'єкті)
//  * mult() перемножає збережені значення і повертає результат (з перевіркою на наявність
//  * властивостей в об'єкті) raise() возводить першу властивість в ступінь другої і повертає
//  * результат ( з перевіркою на наявність властивостей в об'єкті) винеси перевірку на наявність властивостей
...
//   return array.filter(value => value.tags.includes("js"));
// }
...
// client.changeEmail = "aleksandr@gmail.com";
